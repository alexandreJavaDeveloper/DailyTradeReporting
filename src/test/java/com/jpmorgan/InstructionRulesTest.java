...
public class InstructionRulesTest
{
    ...
    {
        final LocalDate instructionDate = LocalDate.of(2017, 3, 25);
        final LocalDate settlementDate = LocalDate.of(2017, 3, 25);

        final Instruction instruction = new Instruction("lets go", FinancialType.SELL, 16.20f, CurrencyType.SGP, instructionDate, settlementDate, 50, 100.00f);
